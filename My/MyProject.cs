...
// Type: File_Downloader.My.MyProject
...
internal sealed class MyProject
{
    ...
    internal sealed class MyForms
    {
        ...
        public Form_Settings Form_Settings
        {
            ...
            get
            {
                this.m_Form_Settings = MyProject.MyForms.Create__Instance__<Form_Settings>(this.m_Form_Settings);
                return this.m_Form_Settings;
            }
            [DebuggerNonUserCode]
            set
            {
                if (value == this.m_Form_Settings)
                    return;
                if (value != null)
                    throw new ArgumentException("Property can only be set to Nothing");
                this.Dispose__Instance__<Form_Settings>(ref this.m_Form_Settings);
            }
        }
