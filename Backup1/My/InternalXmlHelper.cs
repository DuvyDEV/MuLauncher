...
// Type: File_Downloader.My.InternalXmlHelper
...
internal sealed class InternalXmlHelper
{
    ...
    private sealed class RemoveNamespaceAttributesClosure
    {
        ...
        internal XElement ProcessXElement(XElement element)
        {
            return InternalXmlHelper.RemoveNamespaceAttributes(this._inScopePrefixes, this._inScopeNs, this._attributes, element);
        }

        internal object ProcessObject(object obj)
        {
            return InternalXmlHelper.RemoveNamespaceAttributes(this._inScopePrefixes, this._inScopeNs, this._attributes, obj);
        }
    }
}
}
